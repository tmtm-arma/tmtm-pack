...
class tmtm_h_beretField_ins_butan: tmtm_h_beretField_base
{
    author="erem2k";
    ...
    {
        hiddenSelectionsTextures[]= {
            "\tmtm\pack\faction_glf\characters\headgear\Data\tmtm_beretField_ins_butan_co.paa"
        };
    };
};

class tmtm_h_beretField_ins_butang: tmtm_h_beretField_base
{
    author="erem2k";
    ...
    {
        hiddenSelectionsTextures[]= {
            "\tmtm\pack\faction_glf\characters\headgear\Data\tmtm_beretField_ins_butan_green_co.paa"
        };
    };
};
